...
<head>
  ...
  if (!@$state)
    $state = "$companystate";
  if (!@$img)
    $img = base_url('assets/img/logo/favicon.png');
  ...
  <link rel="apple-touch-icon" href="<?= base_url('assets/img/logo/favicon.png') ?>">
  ...
  <script type="application/ld+json">
    {
      ...
      "name": "<?= $company3 ?>",
      "url": "<?= site_url() ?>",
      "logo": "<?= base_url() ?>assets/img/logo/favicon.png"
    }
  </script>
  <script type="application/ld+json">
    {
      ...
      "name": "<?= $company3 ?>",
      "url": "<?= site_url() ?>",
      "image": ["<?= base_url() ?>assets/img/logo/favicon.png"],
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "  
        <?= $address1 ?>",
